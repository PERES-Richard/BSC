            ...
            if(protAssemblage.contains(g.getBegin()) && protAssemblage.contains(g.getEnd())){
                if(g.getBegin().equals(start) && g.getEnd().equals(end)){
                    ...
                    if(g.getEnd().equals(end)){
                        ...
                        theEdges.remove(g);
                        return hamiltonian(g.getEnd(), end, protAssemblage, theEdges);
                    }
                }
                else if(g.getEnd().equals(start)){
                    if(g.getBegin().equals(end)){
                        return true;
                    } else {
                        theEdges.remove(g);
                        return hamiltonian(g.getBegin(), end, protAssemblage, theEdges);
                    }
                }
            }
        }
